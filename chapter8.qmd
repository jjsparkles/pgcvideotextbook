...
> In the following videos, we will explore Transcriptome-Wide Association Studies, or TWAS, including various TWAS methods. In the first video, Dr. Gusev explains the concepts of transcriptome-wide association studies, gene expression prediction related to phenotypes of interest, and accompanying statistical tests. The second video by Drs. Eicher and Zaitlin is a very brief introduction to the concept of a TWAS. In the third video, Dr. Gusev provides a tutorial for conducting a TWAS, using FUSION software.
